            ...
            <form action="" id="manage-order">
                ...
                <div class="bg-dark" id='o-list'>
                            <div class="d-flex w-100 bg-dark mb-1">
                             ...
                             <?php
$items = $conn->query("SELECT COUNT(order_number) AS res FROM orders");
if(isset($items)){
    if($row = $items->fetch_assoc()){
        $aw = $row['res'];
        // Ensure the order number does not exceed 11
        $ka = ($aw % 11) + 1;
?>
        <input type="number" readonly="readonly" style="border: none; background-color: transparent; color: white;" class="form-control-sm" name="order_number" value="<?php echo sprintf("%02d", $ka); ?>" required>
<?php 
    } 
}
?>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="card bg-danger prod-item" data-json = '<?php echo json_encode($row) ?>' data-category-id="<?php echo $row['category_id'] ?>">
                                    <div class="card-body">
                                        <span><b class="text-white">
                                            <?php echo $row['name'] ?>
                                        </b></span>
